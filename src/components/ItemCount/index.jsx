...
export function ItemCount({ stock, initial, onAdd }) {
  ...
  return (
    <div className="w-25 flex-column align-items-strech">
      <div className="m-2 p-2 d-flex justify-content-around align-items-center">
      ...
      <button className="btn w-75" type="button" onClick={()=> onAdd(count)}>Añadir al carrito</button>
    </div>
  );
}
